...
contract DAVerifierTest is DSTest {
    ...
    // deploy a Nuport contract and submit the following:
    // - initial valset.
...
/// transfer transaction that happened on Nubit. It represents the data mentioned in
/// the comment at the beginning of this file.
contract TestFixture {
    /// @notice the share containing the token transfer transaction on Nubit.
    ...
    /// @notice the data root tuple root committing to the Nubit block.
    bytes32 public dataRootTupleRoot = 0xf89859a09c0f2b1bbb039618d0fe60432b8c247f7ccde97814655f2acffb3434;

    /// @notice the data root tuple root nonce in the Nuport contract.
